...
<html lang="es">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="<?= LAYOUTS_PATH; ?>/css/rv.css">
               ...
               <div class="panel panel-default">
                  <div class="panel-body">
                     <table class="table table-responsive table-bordered table-condensed" id="center-table">
                        <tr bgcolor="#D9534F">
                           <th class="text-center tx-white" colspan="10"><?= APP_NAME; ?></th>
                        </tr>
                        <tr bgcolor="#D9534F">
                           ...
                           <th class="text-center tx-white">Comisión 2%</th>
                     ...
                     <h4>La mayor venta fue de $<?= $ventaMayor; ?> hecha por <?= $vendedorMayor; ?>.</h4>
                     <h4>La menor venta fue de $<?= $ventaMenor; ?> hecha por <?= $vendedorMenor; ?>.</h4>
                  </div>
               </div>
               <a href="PDF.php" class="btn btn-danger"><i class="fa fa-fw fa-file-pdf-o"></i> Exportar</a>
            </div>
         </div>
      </div>
      <footer class="footer">
