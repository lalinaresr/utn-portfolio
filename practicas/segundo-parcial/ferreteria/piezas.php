...
<html lang="">
   ...
   <body>
         ...
         <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="piezas.php"><i class="fa fa-fw fa-wrench"></i> Piezas</a></li>
      ...
      <script type="text/javascript" src="assets/js/piezas.js"></script>     
   </body>
</html>