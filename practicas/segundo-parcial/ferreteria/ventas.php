...
<body>
      ...
      <div class="container">
         ...
         <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="<?= APP_URL; ?>ventas.php"><i class="fa fa-fw fa-credit-card"></i> Ventas</a></li>
            </ul>
   ...
   <script type="text/javascript" src="<?= LAYOUTS_PATH; ?>/js/f_sales.js"></script>
</body>
