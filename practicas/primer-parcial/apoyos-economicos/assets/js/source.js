		...
		success: function(response){
			if (response['mensaje'] == "ErrorEstudiante") {
				swal({
					position: 'top-end',
				  	type: 'error',
				  	title: 'Lo sentimos pero no fue acreditado para poder obtener el apoyo.',
				...
				swal({
					position: 'top-end',
				  	type: 'success',
				  	title: 'Felicidades ' + response['nombreCompleto'] + ' has logrado obtener el apoyo de 1000 pesos mexicanos',
				  	showConfirmButton: false,
				  	timer: 1500
				});				
			}
		...
		success: function(response){
			if (response == "ErrorMadreSoltera") {
				swal({
					position: 'top-end',
				  	type: 'error',
				  	title: 'Lo sentimos pero no fue acreditada para poder obtener el apoyo.',
				  	showConfirmButton: false,
				  	timer: 1500
				});
			} else {
				swal({
					position: 'top-end',
				  	type: 'success',
				  	title: 'Felicidades has logrado obtener el apoyo de 1200 pesos mexicanos',
				  	showConfirmButton: false,
				  	timer: 1500
				});				
			}
		...
		success: function(response){
			if (response == "ErrorAdultoMayor") {
				...
				swal({
					position: 'top-end',
				  	type: 'success',
				  	title: 'Felicidades has logrado obtener el apoyo de 900 pesos mexicanos',
				  	showConfirmButton: false,
				  	timer: 1500
				});				
			}
