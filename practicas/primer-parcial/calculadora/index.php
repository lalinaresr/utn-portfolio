...
<html lang="es">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="<?= LAYOUTS_PATH; ?>/css/ob.css">
                  ...
                  <div class="panel-body">
                     ...
                     <form action="show.php" method="post" class="form-horizontal">
                        <div class="form-group">
                           <label for="primer_numero" class="col-sm-4 control-label">Primer Numero:</label>
                           <div class="col-sm-8">
                              <input type="number" id="primer_numero" name="primer_numero" class="form-control" required="true" min=0 step=0.01 autocomplete="off">
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="segundo_numero" class="col-sm-4 control-label">Segundo Numero:</label>
                           <div class="col-sm-8">
                              <input type="number" id="segundo_numero" name="segundo_numero" class="form-control" required="true" min=0 step=0.01 autocomplete="off">
                           </div>
                        </div>
                        <div class="form-group">
